...
Особенности:
 1.Заметил, что в хедере слева пустое пространство (слева от «Заявки»), предположил, что это место для логотипа.
...
2.С таблицей решил сделать так: при уменьшении экрана постепенно исчезают определенные столбы и некоторые данные в ячейках (менее важная информация исчезает в первую очередь). 
Сделал это для того чтобы не появлялась прокрутка таблицы по горизонтали при любой ширине экрана.
